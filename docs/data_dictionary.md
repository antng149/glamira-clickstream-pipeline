...
# Bảng mô tả chi tiết các trường dữ liệu trong collection chính

Field Name             Data Type         Description (Mô tả)                               Example Value
----------------------------------------------------------------------------------------------------------
_id                    ObjectId          Khóa chính tự sinh (Unique ID)                    5ed8cb2...
time_stamp             Number (Long)     Thời gian sự kiện (Unix Timestamp)                1591266092
local_time             String            Thời gian thực tế theo múi giờ người dùng         2020-06-04 12:21:27
ip                     String            Địa chỉ IP người dùng                             37.170.17.183
device_id              String            Mã định danh thiết bị (guest)                     beb2cacb...
user_id_db             String            Mã khách hàng nếu đã đăng nhập                    502567
store_id               String            Mã cửa hàng/quốc gia                              12
collection             String            Loại sự kiện                                      view_product_detail
current_url            String            URL trang hiện tại                                https://glamira.fr/...
...
option                 Array             Danh sách tùy chọn (Màu sắc, size, ...)           [{ "option_label": ... }]
...
# Bảng tham chiếu địa lý được sinh ra từ xử lý IP
